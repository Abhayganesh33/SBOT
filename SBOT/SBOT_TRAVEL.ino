...
void loop() {
 ...
 ///////////////////////////////////////////////////////////////////////
  ...
  pca9685.setPWM(SERVO8_CHANNEL, 0, angleToPulse(20));     //L3B
  delay(100); 



    pca9685.setPWM(SERVO7_CHANNEL, 0, angleToPulse(90));    //L3A
  delay(100);  
  ...
  pca9685.setPWM(SERVO2_CHANNEL, 0, angleToPulse(160));     //L1B
  delay(100);  


    pca9685.setPWM(SERVO1_CHANNEL, 0, angleToPulse(150));      //L1A
  delay(100); 
  ...
  pca9685.setPWM(SERVO11_CHANNEL, 0, angleToPulse(20));     //L4B
  
  delay(100); 



    pca9685.setPWM(SERVO10_CHANNEL, 0, angleToPulse(120));   //L4A
  delay(100); 

 pca9685.setPWM(SERVO11_CHANNEL, 0, angleToPulse(40));     //L4B
  delay(100); 

    pca9685.setPWM(SERVO5_CHANNEL, 0, angleToPulse(170));     //L2B
  delay(100);  

    pca9685.setPWM(SERVO4_CHANNEL, 0, angleToPulse(80));    //L2A
  delay(100); 
